...
def num_translate(word):
    return dict.get(word.lower(), 'не известное слово')
...
def num_translate_adv(word):
    fst_letter = str(word[0])
    if fst_letter == fst_letter.upper():
        return num_translate(word).capitalize()
    else:
        return num_translate(word)
